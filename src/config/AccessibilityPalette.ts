...
export function resolveWorldAccessibilityPalette(
  ...
  if (mode === 'protanopia') {
    return {
      ...
      digSiteColor: highContrast ? 0x8c8b71 : 0x686954,
      digSiteEmissive: highContrast ? 0x253038 : 0x182127,
  ...
  if (mode === 'deuteranopia') {
    return {
      ...
      digSiteColor: highContrast ? 0xa08a5a : 0x705d3d,
      digSiteEmissive: highContrast ? 0x26335a : 0x18203b,
  ...
  if (mode === 'tritanopia') {
    return {
      ...
      digSiteColor: highContrast ? 0xa77b73 : 0x704f4b,
      digSiteEmissive: highContrast ? 0x3f1822 : 0x260f16,
  ...
  return {
    ...
    exitColor: highContrast ? 0xffd24a : 0x5a3f1b,
    placedTorchColor: highContrast ? 0xc78334 : 0x6a4824,
    placedTorchEmissive: highContrast ? 0x572001 : 0x2b1202,
    digSiteColor: highContrast ? 0x937646 : 0x6a5638,
    digSiteEmissive: highContrast ? 0x3b2107 : 0x261608,
